    ...
    return (
        <AppFullScreen>
            ...
            >
                ...
                {/* Title */}
                <Text style={[styles.title, { color: theme.text }]}>Prayer Guide</Text>
                ...
                <View style={[styles.conclusionCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
                    <Text style={[styles.conclusionText, { color: theme.text }]}>Prayer is complete! Remember to pray every day.</Text>
                </View>
