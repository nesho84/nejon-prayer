...
export default function AyahsScreen() {
  ...
  const renderAyahItem = useCallback(({ item }: { item: Verse }) => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [surahIdNum, surahNameStr, mode, theme, arabicFontSize, translationFontSize, arabicFontKey, selectedAyah, translationMap, setLastRead, setLastKhatam, favoriteAyahs, toggleAyahFavorite, isAyahFavorite]);
