export const GLOBAL_TR = {
    ...
    en: {
        ...
        labels: {
            ...
            resetAppButton: "Reset App & Data",
            resetAppTitle: "Reset App?",
            resetAppMessage: "This will delete all your data and restore the app to a fresh install. This can't be undone.",
            resetApp: "Reset",
    ...
    de: {
        ...
        labels: {
            ...
            resetAppButton: "App & Daten zurücksetzen",
            resetAppTitle: "App zurücksetzen?",
            resetAppMessage: "Dadurch werden alle Ihre Daten gelöscht und die App auf den Werkszustand zurückgesetzt. Dies kann nicht rückgängig gemacht werden.",
    ...
    fr: {
        ...
        labels: {
            ...
            resetAppButton: "Réinitialiser l'application et les données",
            resetAppTitle: "Réinitialiser l'application ?",
            resetAppMessage: "Cela supprimera toutes vos données et restaurera l'application à son état d'installation initial. Cette action est irréversible.",
    ...
    sq: {
        ...
        labels: {
            ...
            resetAppButton: "Reseto App & të Dhënat",
            resetAppTitle: "Reseto aplikacionin?",
            resetAppMessage: "Kjo do të fshijë të gjitha të dhënat tuaja dhe do ta rikthejë aplikacionin në gjendjen e instalimit të parë. Ky veprim nuk mund të kthehet.",
            resetApp: "Reseto",
    ...
    bs: {
        ...
        labels: {
            ...
            resetAppButton: "Resetuj aplikaciju i podatke",
            resetAppTitle: "Resetovati aplikaciju?",
            resetAppMessage: "Ovo će obrisati sve vaše podatke i vratiti aplikaciju u prvobitno stanje. Ova radnja se ne može poništiti.",
            resetApp: "Resetuj",
    ...
    mk: {
        ...
        labels: {
            ...
            resetAppButton: "Ресетирај апликација и податоци",
            resetAppTitle: "Да се ресетира апликацијата?",
            resetAppMessage: "Ова ќе избрише сите ваши податоци и ќе ја врати апликацијата во почетна состојба. Ова не може да се врати.",
            resetApp: "Ресетирај",
    ...
    tr: {
        ...
        labels: {
            ...
            resetAppButton: "Uygulamayı ve Verileri Sıfırla",
            resetAppTitle: "Uygulama sıfırlansın mı?",
            resetAppMessage: "Bu işlem tüm verilerinizi silecek ve uygulamayı ilk kurulum durumuna döndürecektir. Bu işlem geri alınamaz.",
            resetApp: "Sıfırla",
    ...
    ar: {
        ...
        labels: {
            ...
            resetAppButton: "إعادة تعيين التطبيق والبيانات",
            resetAppTitle: "إعادة تعيين التطبيق؟",
            resetAppMessage: "سيؤدي هذا إلى حذف جميع بياناتك واستعادة التطبيق إلى حالة التثبيت الأولى. لا يمكن التراجع عن هذا الإجراء.",
