...
export const HOLIDAYS_TR: Record<Language, HolidaysTranslations> = {
  en: {
    ...
    holidays: {
      ...
      ramadan_start: { name: "Ramadan", description: "First day of Ramadan fasting" },
  ...
  de: {
    ...
    holidays: {
      ...
      ramadan_start: { name: "Ramadan", description: "Erster Fastentag im Ramadan" },
  ...
  fr: {
    ...
    holidays: {
      ...
      ramadan_start: { name: "Ramadan", description: "Premier jour du jeûne du Ramadan" },
  ...
  sq: {
    ...
    holidays: {
      hijri_new_year: { name: "Viti i ri Islamik", description: "Dita e parë e Vitit të Ri Hixhri" },
      ashura: { name: "Ashura", description: "Dita e Ashurasë" },
      regaib: { name: "Nata e Regaibit", description: "Nata e Mirë e parë – Regaib" },
      ...
      ramadan_start: { name: "Ramazani", description: "Dita e parë e agjërimit të Ramazanit" },
      laylat_qadr: { name: "Nata e Kadrit", description: "Nata e zbritjes së Kuranit" },
      eid_fitr: { name: "Fitër Bajrami", description: "Dita e parë e Fitër Bajramit" },
      arafah: { name: "Dita e Arafatit", description: "Dita e qëndrimit në Arafat" },
      eid_adha: { name: "Kurban Bajrami", description: "Dita e parë e Kurban Bajramit" },
    },
  },
  bs: {
    ...
    holidays: {
      ...
      ramadan_start: { name: "Ramazan", description: "Prvi dan posta ramazana" },
  ...
  mk: {
    ...
    holidays: {
      ...
      ramadan_start: { name: "Рамазан", description: "Прв ден од постот на Рамазан" },
  ...
  tr: {
    ...
    holidays: {
      ...
      ramadan_start: { name: "Ramazan", description: "Ramazan orucunun ilk günü" },
  ...
  ar: {
    ...
    holidays: {
      ...
      ramadan_start: { name: "رمضان", description: "أول يوم من صيام رمضان" },
