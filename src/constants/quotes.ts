export const QUOTES = {
    ...
    de: [
        ...
        "Und euer Herr sagt: Ruft Mich an, Ich werde euch erhören 💬 (Al-Mu'min 40:60)",
    ...
    sq: [
        ...
        "Dhe Zoti juaj thotë: Më thërrisni Mua, do t'ju përgjigjem 💬 (El-Mumin 40:60)",
    ...
    tr: [
        ...
        "Rabb'in şöyle dedi: Bana dua edin, size cevap vereyim 💬 (Mümin 40:60)",
        ...
        "Kim zerre kadar hayır yaparsa, onu görür 🌻 (Fussilet 41:46)",
    ...
    // ------------------------------------------------------------
    ar: [
        "أَلَا بِذِكْرِ اللَّهِ تَطْمَئِنُّ الْقُلُوبُ 💚 (Ar‑Ra'd 13:28)",
        "إِنَّ ٱلصَّلَاةَ تَنْهَىٰ عَنِ ٱلْفَحْشَاءِ وَٱلْمُنْكَرِ 🌙 (Al‑Ankabut 29:45)",
        "وَأَقِيمُوا ٱلصَّلَاةَ وَءَاتُوا ٱلزَّكَاةَ وَٱرْكَعُوا مَعَ ٱلرَّاكِعِينَ 🕌 (Al‑Baqarah 2:43)",
        "حَٰفِظُوا عَلَى ٱلصَّلَوٰاتِ وَٱلصَّلَاةِ ٱلْوُسْطَىٰ ⏰ (Al‑Baqarah 2:238)",
        "فَٱذْكُرُونِيٓ أَذْكُرْكُمْ ✨ (Al‑Baqarah 2:152)",
        "ٱسْتَعِينُوا۟ بِٱلصَّبْرِ وَٱلصَّلَاةِ 🤲 (Al‑Baqarah 2:153)",
        "فَإِنِّي قَرِيبٌ أُجِيبُ دَعْوَةَ ٱلدَّاعِ إِذَا دَعَانِ 🌟 (Al‑Baqarah 2:186)",
        "وَقَالَ رَبُّكُمُ ٱدْعُونِي أَسْتَجِبْ لَكُمْ 💫 (Al‑Mu'min 40:60)",
        "قَدْ أَفْلَحَ ٱلْمُؤْمِنُونَ ٱلَّذِينَ هُمْ فِي صَلَاتِهِمْ خَاشِعُونَ 🤲 (Al‑Mu'minun 23:1‑2)",
        "لَا يُكَلِّفُ ٱللَّهُ نَفْسًا إِلَّا وُسْعَهَا 🤍 (Al‑Baqarah 2:286)",
        "وَمَن يَتَوَكَّلْ عَلَى ٱللَّهِ فَهُوَ حَسْبُهُ 💙 (At‑Talaq 65:3)",
        "فَإِنَّ مَعَ ٱلْعُسْرِ يُسْرًا • إِنَّ مَعَ ٱلْعُسْرِ يُسْرًا 🌅 (Ash‑Sharh 94:5‑6)",
        "لَا تَقْنَطُوا۟ مِن رَّحْمَةِ ٱللَّهِ 🕊️ (Az‑Zumar 39:53)",
        "وَقَالَ رَبُّكُمُ ٱدْعُونِي أَسْتَجِبْ لَكُمْ 💬 (Al‑Mu'min 40:60)",
        "ٱسْتَعِينُوا۟ بِٱلصَّبْرِ وَٱلصَّلَاةِ إِنَّ ٱللَّهَ مَعَ ٱلصَّٰبِرِينَ ⌚ (Al‑Baqarah 2:153)",
        "وَٱذْكُر رَّبَّكَ كَثِيرًا وَسَبِّحْ بِالْعَشِيِّ وَالْإِبْكَارِ 🌤 (Al‑Imran 3:41)",
        "إِنَّ ٱلصَّلَوٰةَ كَانَتْ عَلَى ٱلْمُؤْمِنِينَ كِتَٰبًا مَّوْقُوتًا ⏳ (An‑Nisa 4:103)",
        "وَمَن يَعْمَلۡ مِثْقَالَ ذَرَّةٍ خَيْرًا يَرَهُۥ 🌻 (Fussilat 41:46)",
